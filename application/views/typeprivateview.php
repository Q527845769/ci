...
<body>
  ...
  <div class="main-container-inner"> <a class="menu-toggler" id="menu-toggler" href="#"> <span class="menu-text"></span> </a>
      ...
      <div class="page-content">
            <?php $this->load->view('common/nav_top1', $header2); ?>
            <div class="row">
          <div class="col-xs-12"> 
                <!-- PAGE CONTENT BEGINS --> 
              ...
              <div class="col-xs-12 col-sm-12 widget-container-span">
                  ...
                  <div class="widget-header header-color-green2">
                        <h5> <i class="icon-arrow-left"></i>
                      <button onclick="javascript:reflesk()" class="btn btn-xs btn-success " style="margin-top:3px;margin-left:10px;"> <i class="icon-star-half icon-on-left"></i> <span class="bigger-110">刷新</span> </button>
                      <button onclick="javascript:saveflesh()" class="btn btn-xs btn-success " style="margin-top:3px;"> <span class="bigger-110">保存</span> <i class="icon-search icon-on-right"></i> </button>
                    </h5>
  ...
  <a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse"> <i class="icon-double-angle-up icon-only bigger-110"></i> </a> </div>
    ...
    <script type="text/javascript">
       ...
       function reflesk(){
           ...
           jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/helloto33/typeprivate/get_private_data", packet, onsuccess, onerrors);;
       }
       ...
       function saveflesh(){
          // alert(objtostr(rowdata["ywgl_jzsd"]["huanwei"]));
           ...
           jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/typeprivate/save_private_data", packet, onsuccess, onerrors);
       }
